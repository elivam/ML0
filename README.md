...
пользователю ближайшего объекта или нескольких. «Прецедентная» логика
работы алгоритма хорошо понятна экспертам в таких предметных областях,
как медицина, биометрия, юриспруденция, и др.
...
### Прямоугольное ядро
![alt text](https://github.com/elivam/ML0/blob/master/pictures/func_round.PNG)
